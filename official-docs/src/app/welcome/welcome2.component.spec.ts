...
describe('Welcome2Component', () => {
  ...
  beforeEach(async () => { //El beforeEach 
    await TestBed.configureTestingModule({ 
      //declarations: [  Welcome2Component], Si creamos el componente con TestBed con el inject, y no con el fixture, necesitamos meterlo en los providers. ADemas si lo ponemos aqui, coge el componente tal cual, con sus propios providers si los tuviera, y aunque en el test bed le pongas nuevos, no los coge
      declarations: [  ],
